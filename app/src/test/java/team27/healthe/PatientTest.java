...
//        Integer problem = new Problem("i am a problem", new Date(), "I just got created");
//
...
//        Integer problem = new Problem(problemTitle, new Date(), "should I be red?");
//        patient.addProblem(problem);
//
...
//        Patient patient = new Patient("apple", "apple@google.com", "1515151515");
//        Integer problem = new Problem("im am green", new Date(), "should I be red?");
//        patient.addProblem(problem);
//
